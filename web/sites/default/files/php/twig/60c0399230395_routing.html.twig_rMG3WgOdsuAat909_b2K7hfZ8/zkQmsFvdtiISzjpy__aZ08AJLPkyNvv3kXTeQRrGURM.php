...
class __TwigTemplate_82179354ec7ce29633c35e5bceee828ffa1c3a44e3bf500da74c83784c27bdec extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"sf-toolbar-block\">
        ...
        // line 19
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (((isset($context["icon"]) || array_key_exists("icon", $context))) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["icon"] ?? null), 19, $this->source), "")) : ("")), "html", null, true);
        echo "</div>
        <div class=\"sf-toolbar-info\">";
        // line 20
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (((isset($context["text"]) || array_key_exists("text", $context))) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["text"] ?? null), 20, $this->source), "")) : ("")), "html", null, true);
        echo "</div>
    </div>
";
...
{% endblock %}
", "@webprofiler/Collector/routing.html.twig", "/var/www/html/web/modules/contrib/devel/webprofiler/templates/Collector/routing.html.twig");
    }
